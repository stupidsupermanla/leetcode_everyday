...
public class P1128NumberOfEquivalentDominoPairs {
    public static void main(String[] args) {
        ...
        // TO TEST
        System.out.println(solution.numEquivDominoPairs(new int[][]{{1, 2}, {2, 1}, {1, 2}, {5, 6}}));
    }
    ...
    class Solution {
        public int numEquivDominoPairs(int[][] dominoes) {
            ...
            for (int[] dominoe : dominoes) {
                String key = dominoe[0]<dominoe[1]?String.valueOf(dominoe[0]) + dominoe[1]:String.valueOf(dominoe[1]) + dominoe[0];
